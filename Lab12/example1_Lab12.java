...
public class example1_Lab12 {
    public static void main(String[] args) throws IOException{
        Reader in = null; // можно сразу записать FileReader in=null;
        Writer out = null; // можно сразу записать FileWriter out =null;
        try {
            in = new FileReader("C:\\Java\\kek.txt"); // файл для чтения
            out = new FileWriter("C:\\Java\\kek2.txt", true); // файл для записи разрешено добавление
